...
// configuration step. It creates a namespace called `cpp_weekly_cmake_template`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cpp_weekly_cmake_template::cmake::project_name, cpp_weekly_cmake_template::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cpp_weekly_cmake_template::cmake::project_version);
      return EXIT_SUCCESS;
    }
